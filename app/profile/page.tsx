...
export default function ProfilePage() {
  ...
  const languages = [
    { name: "Python", key: "python" as const, icon: "🐍", color: "from-yellow-400 to-yellow-600" },
    { name: "Java", key: "java" as const, icon: "☕", color: "from-orange-400 to-red-600" },
    { name: "C++", key: "cpp" as const, icon: "⚡", color: "from-blue-400 to-blue-600" },
  ]
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Profile Header */}
        <div className="bg-[#8989a7] text-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              {/* Avatar */}
              <div className="relative">
                <div className="w-32 h-32 rounded-full bg-blue-400 flex items-center justify-center text-5xl font-bold shadow-2xl border-4 border-white">
                  {user.username?.charAt(0).toUpperCase() || user.email?.charAt(0).toUpperCase()}
                </div>
                <button className="absolute bottom-0 right-0 bg-white text-gray-700 rounded-full p-2 shadow-lg hover:bg-gray-100 transition">
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="flex flex-col md:flex-row md:items-center gap-3 mb-3">
                  ...
                  <Badge className="bg-yellow-500 text-white hover:bg-yellow-600 w-fit mx-auto md:mx-0">
                    Level {Math.floor(userProgress.totalXP / 100)}
                  </Badge>
                </div>
                <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 text-white/90 mb-4">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-6 mt-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-white/80">Levels Completed</div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-bold">{userProgress.achievements.length}</div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="text-right">
                          <div className="text-2xl font-bold text-gray-900">{progress.xp}</div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                    ...
                    <span className="text-xl font-bold text-yellow-600">{userProgress.totalXP}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium text-gray-700">Levels Done</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                    ...
                    <span className="text-xl font-bold text-purple-600">{userProgress.achievements.length}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-yellow-50p-4 rounded-lg text-center border border-yellow-200">
                      <div className="text-3xl mb-2">🎯</div>
                      <div className="text-xs font-semibold text-gray-700">First Steps</div>
                    </div>
                    <div className="bg-blue-50p-4 rounded-lg text-center border border-blue-200">
                      <div className="text-3xl mb-2">⭐</div>
                      <div className="text-xs font-semibold text-gray-700">Rising Star</div>
                    </div>
                    <div className="bg-gray-100 p-4 rounded-lg text-center border border-gray-200 opacity-50">
                      <div className="text-3xl mb-2">🔒</div>
                      <div className="text-xs font-semibold text-gray-500">Locked</div>
                    </div>
                    <div className="bg-gray-100 p-4 rounded-lg text-center border border-gray-200 opacity-50">
                      <div className="text-3xl mb-2">🔒</div>
                      <div className="text-xs font-semibold text-gray-500">Locked</div>
